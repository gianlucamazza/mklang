...
| pattern            | blocker                                                                                                                                                                                            |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ReAct              | needs host `tool:`s — tool names are static, so the host must author the machine around its own tools ([`examples/react.mk`](https://github.com/gianlucamazza/mklang/blob/main/examples/react.mk)) |
